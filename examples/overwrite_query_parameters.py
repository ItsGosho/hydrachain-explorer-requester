...
from hydrachain_explorer_requester.query_parameters import TransactionsQueryParameters, QueryParameter
...
query_parameters = TransactionsQueryParameters(
    page = QueryParameter('pageOverwritten', None)
)
query_parameters.set_page(0)  #The request will be made with pageOverwritten=0 instead of page=0
